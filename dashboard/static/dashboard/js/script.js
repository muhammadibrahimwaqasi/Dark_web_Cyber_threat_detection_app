...
function selectAttackType(element) {
    ...
    // Use enhanced attack database if available
    if (typeof attackDatabase !== 'undefined' && attackDatabase[attackType]) {
        showEnhancedAttackDetails(attackDatabase[attackType]);
    } else {
...
function showAttackDetails(attackType, attackName) {
    // Use enhanced version if database is available
    if (typeof attackDatabase !== 'undefined' && attackDatabase[attackType]) {
        showEnhancedAttackDetails(attackDatabase[attackType]);
        return;
    }
